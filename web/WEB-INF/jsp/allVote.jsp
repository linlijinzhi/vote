        ...
        layui.use('table', function(){
            ...
            table.render({
                ...
                ,cols: [[
                    ...
                    ,{field:'battleId', title:'场次号', width:160, sort: true}
                    ,{field:'matchId', title:'比赛号', width:160, sort: true}
                    ,{field:'vote1', title:'票数1', width:180, sort: true}
                    ,{field:'vote2', title:'票数2', width:180,sort: true}
